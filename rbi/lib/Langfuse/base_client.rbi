...
module Langfuse
  class BaseClient
    ...
    RequestComponentsShape = T.type_alias do
      {
        ...
        page: T.nilable(T::Class[Langfuse::BasePage[Langfuse::BaseModel]]),
        stream: T.nilable(T::Class[T.anything]),
        model: T.nilable(Langfuse::Converter::Input),
        options: T.nilable(T.any(Langfuse::RequestOptions, T::Hash[Symbol, T.anything]))
      }
    end
    ...
    class << self
      sig { params(req: Langfuse::BaseClient::RequestComponentsShape).void }
      def validate!(req)
      end
      ...
      sig do
        params(
          request: Langfuse::BaseClient::RequestInputShape,
          status: Integer,
          response_headers: T.any(T::Hash[String, String], Net::HTTPHeader)
        )
          .returns(Langfuse::BaseClient::RequestInputShape)
      end
    ...
    sig do
      overridable
        .params(req: Langfuse::BaseClient::RequestComponentsShape, opts: T::Hash[Symbol, T.anything])
        .returns(Langfuse::BaseClient::RequestInputShape)
    end
