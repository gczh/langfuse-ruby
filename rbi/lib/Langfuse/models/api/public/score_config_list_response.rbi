    ...
    module API
      module Public
        class ScoreConfigListResponse < Langfuse::BaseModel
          sig { returns(T::Array[Langfuse::Models::API::Public::ScoreConfig]) }
          def data
          end

          sig do
            params(_: T::Array[Langfuse::Models::API::Public::ScoreConfig])
              .returns(T::Array[Langfuse::Models::API::Public::ScoreConfig])
          end
          def data=(_)
          end
          ...
          sig do
            params(
              data: T::Array[Langfuse::Models::API::Public::ScoreConfig],
