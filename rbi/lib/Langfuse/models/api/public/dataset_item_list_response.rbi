    ...
    module API
      module Public
        class DatasetItemListResponse < Langfuse::BaseModel
          sig { returns(T::Array[Langfuse::Models::API::Public::DatasetItem]) }
          def data
          end

          sig do
            params(_: T::Array[Langfuse::Models::API::Public::DatasetItem])
              .returns(T::Array[Langfuse::Models::API::Public::DatasetItem])
          end
          def data=(_)
          end
          ...
          sig do
            params(
              data: T::Array[Langfuse::Models::API::Public::DatasetItem],
