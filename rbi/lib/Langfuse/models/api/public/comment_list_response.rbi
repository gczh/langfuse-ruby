    ...
    module API
      module Public
        class CommentListResponse < Langfuse::BaseModel
          sig { returns(T::Array[Langfuse::Models::API::Public::Comment]) }
          def data
          end

          sig do
            params(_: T::Array[Langfuse::Models::API::Public::Comment])
              .returns(T::Array[Langfuse::Models::API::Public::Comment])
          end
          def data=(_)
          end
          ...
          sig do
            params(
              data: T::Array[Langfuse::Models::API::Public::Comment],
