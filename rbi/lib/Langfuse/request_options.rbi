...
module Langfuse
  module RequestParameters
    ...
    sig { returns(T.any(Langfuse::RequestOptions, T::Hash[Symbol, T.anything])) }
    def request_options
    end

    sig do
      params(_: T.any(Langfuse::RequestOptions, T::Hash[Symbol, T.anything]))
        .returns(T.any(Langfuse::RequestOptions, T::Hash[Symbol, T.anything]))
    end
