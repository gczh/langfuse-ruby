...
module Langfuse
  module Util
    ...
    class << self
      sig { params(url: T.any(URI::Generic, String)).returns(Langfuse::Util::ParsedUriShape) }
      def parse_uri(url)
      end

      sig { params(parsed: Langfuse::Util::ParsedUriShape).returns(URI::Generic) }
      def unparse_uri(parsed)
      end

      sig do
        params(lhs: Langfuse::Util::ParsedUriShape, rhs: Langfuse::Util::ParsedUriShape).returns(URI::Generic)
      end
    ...
    class << self
      ...
      sig { params(lines: T::Enumerable[String]).returns(Langfuse::Util::ServerSentEvent) }
