...
module Langfuse
  module Converter
    ...
    Input = T.type_alias { T.any(Langfuse::Converter, T::Class[T.anything]) }
    ...
    class << self
          ...
          spec: T.any(
            {
              ...
              enum: T.nilable(T.proc.returns(Langfuse::Converter::Input)),
              union: T.nilable(T.proc.returns(Langfuse::Converter::Input))
            },
            T.proc.returns(Langfuse::Converter::Input),
            Langfuse::Converter::Input
          )
        )
      ...
      sig { params(target: Langfuse::Converter::Input, value: T.anything).returns(T.anything) }
  ...
  class Union
    ...
    class << self
      ...
      sig { params(value: T.anything).returns(T.nilable(Langfuse::Converter::Input)) }
  ...
  class ArrayOf
    ...
    sig { returns(Langfuse::Converter::Input) }
  ...
  class BaseModel
    ...
    class << self
      sig do
        returns(
          T::Hash[Symbol,
                  T.all(
                    Langfuse::BaseModel::KnownFieldShape,
                    {type_fn: T.proc.returns(Langfuse::Converter::Input)}
                  )]
        )
      end
      def known_fields
      ...
      sig do
        returns(
          T::Hash[Symbol,
                  T.all(Langfuse::BaseModel::KnownFieldShape, {type: Langfuse::Converter::Input})]
        )
      end
      def fields
      end
    ...
    class << self
      sig do
        override
          .params(value: T.any(Langfuse::BaseModel, T::Hash[T.anything, T.anything], T.anything))
