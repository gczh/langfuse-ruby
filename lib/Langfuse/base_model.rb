...
module Langfuse
  ...
  module Converter
    ...
    class << self
      # @private
      #
      # @param spec [Hash{Symbol=>Object}, Proc, Langfuse::Converter, Class] .
      #
      ...
      def type_info(spec)
        ...
        in Proc
          spec
        in Langfuse::Converter | Class | Symbol
          -> { spec }
        in true | false
          -> { Langfuse::BooleanModel }
      ...
      #
      # @param target [Langfuse::Converter, Class]
      # @param value [Object]
      #
      # @return [Object]
      #
  ...
  class Unknown
    ...
    # @return [Boolean]
    #
    def self.==(other) = other.is_a?(Class) && other <= Langfuse::Unknown
  ...
  class BooleanModel
    ...
    # @return [Boolean]
    #
    def self.==(other) = other.is_a?(Class) && other <= Langfuse::BooleanModel
  ...
  # @example
  # ```ruby
  # # `annotation_queue_object_type` is a `Langfuse::Models::API::Public::AnnotationQueues::AnnotationQueueObjectType`
  # case annotation_queue_object_type
  # when Langfuse::Models::API::Public::AnnotationQueues::AnnotationQueueObjectType::TRACE
  #   # ...
  # when Langfuse::Models::API::Public::AnnotationQueues::AnnotationQueueObjectType::OBSERVATION
  #   # ...
  # else
  #   # ...
  # end
  ...
  class Enum
    ...
    #
    def self.==(other)
      other.is_a?(Class) && other <= Langfuse::Enum && other.values.to_set == values.to_set
    end
  ...
  # @example
  # ```ruby
  # # `ingestion_usage` is a `Langfuse::Models::API::IngestionUsage`
  # case ingestion_usage
  # when Langfuse::Models::API::Public::Usage
  #   # ...
  # when Langfuse::Models::API::IngestionUsage::OpenAIUsage
  #   # ...
  # else
  #   # ...
  # end
  ...
  class Union
    ...
    class << self
      ...
      # @private
      #
      # @param key [Symbol, Hash{Symbol=>Object}, Proc, Langfuse::Converter, Class]
      #
      # @param spec [Hash{Symbol=>Object}, Proc, Langfuse::Converter, Class] .
      #
      #   @option spec [NilClass, TrueClass, FalseClass, Integer, Float, Symbol] :const
      ...
      private def variant(key, spec = nil)
        variant_info =
          case key
          in Symbol
            [key, Langfuse::Converter.type_info(spec)]
          in Proc | Langfuse::Converter | Class | Hash
            [nil, Langfuse::Converter.type_info(key)]
          end
      ...
      # @param value [Object]
      #
      # @return [Langfuse::Converter, Class, nil]
      #
      private def resolve_variant(value)
        case [@discriminator, value]
        in [_, Langfuse::BaseModel]
          value.class
        in [Symbol, Hash]
          key =
          ...
          resolved.nil? ? Langfuse::Unknown : resolved.call
        else
          nil
        end
      end
    ...
    #
    def self.==(other)
      other.is_a?(Class) && other <= Langfuse::Union && other.variants == variants
    end
    ...
    class << self
      ...
      def coerce(value)
        if (variant = resolve_variant(value))
          return Langfuse::Converter.coerce(variant, value)
        end
        ...
        known_variants.each do |_, variant_fn|
          ...
          case Langfuse::Converter.try_strict_coerce(variant, value)
          in [true, coerced, _]
            return coerced
          in [false, true, score]
        ...
        variant.nil? ? value : Langfuse::Converter.coerce(variant, value)
      end
      ...
      def dump(value)
        if (variant = resolve_variant(value))
          return Langfuse::Converter.dump(variant, value)
        end
  ...
  class ArrayOf
    ...
    # @return [Boolean]
    #
    def ==(other) = other.is_a?(Langfuse::ArrayOf) && other.item_type == item_type
    ...
    def coerce(value)
      ...
      in Enumerable unless value.is_a?(Hash)
        value.map { Langfuse::Converter.coerce(type, _1) }
      else
        value
      end
    end
    ...
    def dump(value)
      ...
      case value
      in Enumerable unless value.is_a?(Hash)
        value.map { Langfuse::Converter.dump(type, _1) }.to_a
      else
        value
      end
    end
    ...
    def try_strict_coerce(value)
      ...
      in Array
        ...
        mapped =
          value.map do |item|
            case Langfuse::Converter.try_strict_coerce(type, item)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
    ...
    # @private
    #
    # @return [Langfuse::Converter, Class]
    #
    protected def item_type = @item_type_fn.call

    # @private
    #
    # @param type_info [Hash{Symbol=>Object}, Proc, Langfuse::Converter, Class]
    #
    ...
    def initialize(type_info, spec = {})
      @item_type_fn = Langfuse::Converter.type_info(type_info || spec)
    end
  end
  ...
  class HashOf
    ...
    # @return [Boolean]
    #
    def ==(other) = other.is_a?(Langfuse::HashOf) && other.item_type == item_type
    ...
    def coerce(value)
      ...
      in Hash
        value.to_h do |key, val|
          coerced = Langfuse::Converter.coerce(type, val)
    ...
    def dump(value)
      ...
      in Hash
        value.transform_values do |val|
          Langfuse::Converter.dump(type, val)
        end
      else
        value
      end
    ...
    def try_strict_coerce(value)
      ...
      in Hash
        ...
        mapped =
          value.transform_values do |val|
            case Langfuse::Converter.try_strict_coerce(type, val)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
  ...
  # @example
  # ```ruby
  # # `base_event` is a `Langfuse::Models::API::BaseEvent`
  # base_event => {
  #   id: id,
  #   timestamp: timestamp,
  #   metadata: metadata
  ...
  class BaseModel
    ...
    class << self
      ...
      #
      def known_fields
        @known_fields ||= (self < Langfuse::BaseModel ? superclass.known_fields.dup : {})
      end
      ...
      private def add_field(name_sym, required:, type_info:, spec:)
        type_fn, info =
          case type_info
          in Proc | Class | Langfuse::Converter
            [Langfuse::Converter.type_info({**spec, union: type_info}), spec]
          in Hash
            [Langfuse::Converter.type_info(type_info), type_info]
          end
        ...
        define_method(name_sym) do
          ...
          Langfuse::Converter.coerce(field_type, value)
        rescue StandardError
          name = self.class.name.split("::").last
          raise Langfuse::ConversionError.new(
    ...
    class << self
      # @private
      #
      # @param value [Langfuse::BaseModel, Hash{Object=>Object}, Object]
      #
      # @return [Langfuse::BaseModel, Object]
      #
      def coerce(value)
        case Langfuse::Util.coerce_hash(value)
        in Hash => coerced
          new(coerced)
        else
          value
      ...
      # @private
      #
      # @param value [Langfuse::BaseModel, Object]
      #
      # @return [Hash{Object=>Object}, Object]
      #
      def dump(value)
        unless (coerced = Langfuse::Util.coerce_hash(value)).is_a?(Hash)
          return value
        end
        ...
        values = coerced.filter_map do |key, val|
          ...
          in nil
            ...
            in :coerce
              ...
              target = type_fn.call
              [api_name, Langfuse::Converter.dump(target, val)]
            end
          end
        end.to_h
      ...
      def try_strict_coerce(value)
        ...
        known_fields.each_value do |field|
          ...
          in [_, true]
            ...
            case Langfuse::Converter.try_strict_coerce(target, item)
            in [true, coerced, score]
              tally += score
    ...
    #
    # @param data [Hash{Symbol=>Object}, Langfuse::BaseModel]
    #
    def initialize(data = {})
      case Langfuse::Util.coerce_hash(data)
      in Hash => coerced
        @data = coerced.transform_keys(&:to_sym)
      else
        raise ArgumentError.new("Expected a #{Hash} or #{Langfuse::BaseModel}, got #{data.inspect}")
      end
    end
