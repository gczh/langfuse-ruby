      ...
      module Public
        module Datasets
          class RunListResponse < Langfuse::BaseModel
            # @!attribute data
            #
            #   @return [Array<Langfuse::Models::API::Public::Datasets::DatasetRun>]
            required :data, -> { Langfuse::ArrayOf[Langfuse::Models::API::Public::Datasets::DatasetRun] }
            ...
            # @!parse
            #   # @param data [Array<Langfuse::Models::API::Public::Datasets::DatasetRun>]
