...
class LangfuseTest < Minitest::Test
  def setup
  ...
  def test_client_default_request_default_retry_attempts
    ...
    langfuse.requester = requester

    assert_raises(Langfuse::InternalServerError) do
      langfuse.api.public.annotation_queues.list
    end
  ...
  def test_client_default_request_given_retry_attempts
    ...
    assert_raises(Langfuse::InternalServerError) do
      langfuse.api.public.annotation_queues.list(request_options: {max_retries: 3})
    end
  ...
  def test_client_given_request_given_retry_attempts
    ...
    assert_raises(Langfuse::InternalServerError) do
      langfuse.api.public.annotation_queues.list(request_options: {max_retries: 4})
    end
  ...
  def test_client_redirect_307
    ...
    assert_raises(Langfuse::APIConnectionError) do
      langfuse.api.public.annotation_queues.list(request_options: {extra_headers: {}})
    end
